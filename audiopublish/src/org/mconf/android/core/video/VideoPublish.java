...
public class VideoPublish extends Thread implements RtmpReader {
	...
	private VoiceInterface mVoiceItf;
    ...
    public void startPublisher(ClientOptions opt) {
    	String streamName;
    	
    	//streamName="Test1";
    	/*videoPublishHandler = new BbbVideoPublisher(context, this, opt.getStreamName(), opt);
    	videoPublishHandler.start();*/
    	mVoiceItf=new VoiceOverRtmp(context, opt);
		mVoiceItf.start();
    }        	
